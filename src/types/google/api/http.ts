...
export const Http: MessageFns<Http> = {
  fromJSON(object: any): Http {
    return {
      ...
      fullyDecodeReservedExpansion: isSet(object.fully_decode_reserved_expansion)
...
export const HttpRule: MessageFns<HttpRule> = {
  fromJSON(object: any): HttpRule {
    return {
      ...
      responseBody: isSet(object.response_body) ? globalThis.String(object.response_body) : "",
