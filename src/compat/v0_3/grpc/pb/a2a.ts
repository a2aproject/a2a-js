...
export const AgentCard: MessageFns<AgentCard> = {
  encode(message: AgentCard, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.securitySchemes).forEach(
      ([key, value]: [string, SecurityScheme]) => {
        AgentCard_SecuritySchemesEntry.encode(
...
export const AgentCard_SecuritySchemesEntry: MessageFns<AgentCard_SecuritySchemesEntry> = {
  encode(
    message: AgentCard_SecuritySchemesEntry,
    writer: BinaryWriter = new BinaryWriter()
  ): BinaryWriter {
    if (message.key !== '') {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.flow = {
            $case: 'implicit',
            value: ImplicitOAuthFlow.decode(reader, reader.uint32()),
          };
          continue;
        }
        case 4: {
          ...
          message.flow = {
            $case: 'password',
            value: PasswordOAuthFlow.decode(reader, reader.uint32()),
          };
          continue;
        }
      }
...
export const AuthorizationCodeOAuthFlow: MessageFns<AuthorizationCodeOAuthFlow> = {
  encode(
    ...
    globalThis.Object.entries(message.scopes).forEach(([key, value]: [string, string]) => {
      AuthorizationCodeOAuthFlow_ScopesEntry.encode(
        { key: key as any, value },
...
export const AuthorizationCodeOAuthFlow_ScopesEntry: MessageFns<AuthorizationCodeOAuthFlow_ScopesEntry> =
  {
    encode(
      message: AuthorizationCodeOAuthFlow_ScopesEntry,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      if (message.key !== '') {
        writer.uint32(10).string(message.key);
...
export const ClientCredentialsOAuthFlow: MessageFns<ClientCredentialsOAuthFlow> = {
  encode(
    ...
    globalThis.Object.entries(message.scopes).forEach(([key, value]: [string, string]) => {
      ClientCredentialsOAuthFlow_ScopesEntry.encode(
        { key: key as any, value },
...
export const ClientCredentialsOAuthFlow_ScopesEntry: MessageFns<ClientCredentialsOAuthFlow_ScopesEntry> =
  {
    encode(
      message: ClientCredentialsOAuthFlow_ScopesEntry,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      if (message.key !== '') {
        writer.uint32(10).string(message.key);
...
export const ImplicitOAuthFlow: MessageFns<ImplicitOAuthFlow> = {
  encode(message: ImplicitOAuthFlow, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.scopes).forEach(([key, value]: [string, string]) => {
      ImplicitOAuthFlow_ScopesEntry.encode(
        { key: key as any, value },
        writer.uint32(26).fork()
      ).join();
    });
...
export const ImplicitOAuthFlow_ScopesEntry: MessageFns<ImplicitOAuthFlow_ScopesEntry> = {
  encode(
    message: ImplicitOAuthFlow_ScopesEntry,
    writer: BinaryWriter = new BinaryWriter()
  ): BinaryWriter {
    if (message.key !== '') {
      writer.uint32(10).string(message.key);
...
export const PasswordOAuthFlow: MessageFns<PasswordOAuthFlow> = {
  encode(message: PasswordOAuthFlow, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.scopes).forEach(([key, value]: [string, string]) => {
      PasswordOAuthFlow_ScopesEntry.encode(
        { key: key as any, value },
        writer.uint32(26).fork()
      ).join();
    });
...
export const PasswordOAuthFlow_ScopesEntry: MessageFns<PasswordOAuthFlow_ScopesEntry> = {
  encode(
    message: PasswordOAuthFlow_ScopesEntry,
    writer: BinaryWriter = new BinaryWriter()
  ): BinaryWriter {
    if (message.key !== '') {
      writer.uint32(10).string(message.key);
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.payload = {
            $case: 'statusUpdate',
            value: TaskStatusUpdateEvent.decode(reader, reader.uint32()),
          };
          continue;
        }
        case 4: {
          ...
          message.payload = {
            $case: 'artifactUpdate',
            value: TaskArtifactUpdateEvent.decode(reader, reader.uint32()),
          };
          continue;
        }
      }
...
export const A2AServiceService = {
  ...
  sendStreamingMessage: {
    ...
    requestSerialize: (value: SendMessageRequest): Buffer =>
      Buffer.from(SendMessageRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): SendMessageRequest => SendMessageRequest.decode(value),
    responseSerialize: (value: StreamResponse): Buffer =>
      Buffer.from(StreamResponse.encode(value).finish()),
  ...
  getTask: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetTaskRequest): Buffer =>
      Buffer.from(GetTaskRequest.encode(value).finish()),
  ...
  cancelTask: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CancelTaskRequest): Buffer =>
      Buffer.from(CancelTaskRequest.encode(value).finish()),
  ...
  taskSubscription: {
    ...
    requestDeserialize: (value: Buffer): TaskSubscriptionRequest =>
      TaskSubscriptionRequest.decode(value),
    responseSerialize: (value: StreamResponse): Buffer =>
      Buffer.from(StreamResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): StreamResponse => StreamResponse.decode(value),
  },
  ...
  createTaskPushNotificationConfig: {
    ...
    responseDeserialize: (value: Buffer): TaskPushNotificationConfig =>
      TaskPushNotificationConfig.decode(value),
  },
  ...
  getAgentCard: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetAgentCardRequest): Buffer =>
      Buffer.from(GetAgentCardRequest.encode(value).finish()),
...
export interface A2AServiceServer extends UntypedServiceImplementation {
  ...
  >;
  /** Get a push notification config for a task. */
  getTaskPushNotificationConfig: handleUnaryCall<
    GetTaskPushNotificationConfigRequest,
    TaskPushNotificationConfig
  >;
  /** Get a list of push notifications configured for a task. */
...
export const A2AServiceClient = makeGenericClientConstructor(
  A2AServiceService,
  'a2a.v1.A2AService'
) as unknown as {
  new (
