...
export function withA2AExtensions(...extensions: ExtensionIds): ServiceParametersUpdate {
  return (parameters: ServiceParameters) => {
    parameters[HTTP_EXTENSION_HEADER] = ExtensionIds.toServiceParameter(extensions);
  };
}
