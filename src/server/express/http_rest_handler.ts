...
export function httpRestHandler(options: HttpRestHandlerOptions): RequestHandler {
  ...
  const handleError = (res: Response, error: unknown): void => {
    ...
    sendResponse(res, statusCode, toHTTPError(a2aError));
  };
  ...
  router.get(
    ...
    asyncHandler(async (req, res) => {
      ...
      sendResponse(res, HTTP_STATUS.OK, result, context);
    })
  );
  ...
  router.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      sendResponse(res, HTTP_STATUS.CREATED, result, context);
    })
  );
  ...
  router.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      sendResponse(res, HTTP_STATUS.ACCEPTED, result, context);
    })
  );
  ...
  router.delete(
    ...
    asyncHandler(async (req, res) => {
      ...
      sendResponse(res, HTTP_STATUS.NO_CONTENT, undefined, context);
    })
  );
