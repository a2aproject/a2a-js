...
export interface TaskStatus {
	 ...
	 *
	 * @generated from protobuf field: a2a.v1.Message update = 2
	 */
	update?: Message;
	/**
...
export interface SendMessageResponse {
	...
	payload:
		...
		| {
				oneofKind: "msg";
				/**
				 * @generated from protobuf field: a2a.v1.Message msg = 2
				 */
				msg: Message;
		  }
		| {
...
class SendMessageConfiguration$Type extends MessageType<SendMessageConfiguration> {
	...
	create(
		value?: PartialMessage<SendMessageConfiguration>,
	...
	internalBinaryRead(
		...
		target?: SendMessageConfiguration,
	): SendMessageConfiguration {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.PushNotificationConfig push_notification */ 2:
					message.pushNotification = PushNotificationConfig.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
	...
	internalBinaryWrite(
		...
		for (let i = 0; i < message.acceptedOutputModes.length; i++)
			writer
				...
				.string(message.acceptedOutputModes[i]);
		/* a2a.v1.PushNotificationConfig push_notification = 2; */
		if (message.pushNotification)
			PushNotificationConfig.internalBinaryWrite(
				message.pushNotification,
...
class Task$Type extends MessageType<Task> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.TaskStatus status */ 3:
					message.status = TaskStatus.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.status,
				...
				case /* repeated a2a.v1.Artifact artifacts */ 4:
					message.artifacts.push(
						Artifact.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				case /* repeated a2a.v1.Message history */ 5:
					message.history.push(
						Message.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				case /* google.protobuf.Struct metadata */ 6:
					message.metadata = Struct.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.metadata,
	...
	internalBinaryWrite(
		...
		if (message.status)
			TaskStatus.internalBinaryWrite(
				message.status,
		...
		super("a2a.v1.TaskStatus", [
			{
				...
				name: "state",
				kind: "enum",
				T: () => ["a2a.v1.TaskState", TaskState, "TASK_STATE_"],
			},
			{ no: 2, name: "update", kind: "message", T: () => Message },
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* a2a.v1.TaskState state */ 1:
					...
					break;
				case /* a2a.v1.Message update */ 2:
					message.update = Message.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.update,
...
class Part$Type extends MessageType<Part> {
	...
	create(value?: PartialMessage<Part>): Part {
		...
		if (value !== undefined) reflectionMergePartial<Part>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.FilePart file */ 2:
					message.part = {
						oneofKind: "file",
						file: FilePart.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.part as any).file,
						),
					};
					break;
				case /* a2a.v1.DataPart data */ 3:
					message.part = {
						oneofKind: "data",
						data: DataPart.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.part as any).data,
						),
					};
					break;
				default:
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* google.protobuf.Struct data */ 1:
					message.data = Struct.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.data,
...
class Message$Type extends MessageType<Message> {
			...
			switch (fieldNo) {
				...
				case /* repeated a2a.v1.Part content */ 5:
					message.content.push(
						Part.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				case /* google.protobuf.Struct metadata */ 6:
					message.metadata = Struct.internalBinaryRead(
	...
	internalBinaryWrite(
		...
		/* a2a.v1.Role role = 4; */
		if (message.role !== 0) writer.tag(4, WireType.Varint).int32(message.role);
		/* repeated a2a.v1.Part content = 5; */
		for (let i = 0; i < message.content.length; i++)
			Part.internalBinaryWrite(
				message.content[i],
				writer.tag(5, WireType.LengthDelimited).fork(),
				options,
			).join();
...
class TaskArtifactUpdateEvent$Type extends MessageType<TaskArtifactUpdateEvent> {
	...
	create(
		value?: PartialMessage<TaskArtifactUpdateEvent>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: TaskArtifactUpdateEvent,
	): TaskArtifactUpdateEvent {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.Artifact artifact */ 3:
					message.artifact = Artifact.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.artifact,
...
class PushNotificationConfig$Type extends MessageType<PushNotificationConfig> {
	constructor() {
		super("a2a.v1.PushNotificationConfig", [
			...
			{ no: 3, name: "token", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
			{
				...
				name: "authentication",
				kind: "message",
				T: () => AuthenticationInfo,
			},
		]);
	}
	create(
		value?: PartialMessage<PushNotificationConfig>,
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.AuthenticationInfo authentication */ 4:
					message.authentication = AuthenticationInfo.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
	...
	internalBinaryWrite(
		...
		if (message.authentication)
			AuthenticationInfo.internalBinaryWrite(
				message.authentication,
				writer.tag(4, WireType.LengthDelimited).fork(),
				options,
			).join();
...
class AgentCard$Type extends MessageType<AgentCard> {
	constructor() {
		super("a2a.v1.AgentCard", [
			...
			},
			{
				...
				V: { kind: "message", T: () => SecurityScheme },
			},
			{
				no: 9,
				name: "security",
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* repeated a2a.v1.AgentInterface additional_interfaces */ 15:
					message.additionalInterfaces.push(
						AgentInterface.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				case /* a2a.v1.AgentProvider provider */ 4:
					message.provider = AgentProvider.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.provider,
				...
				case /* a2a.v1.AgentCapabilities capabilities */ 7:
					message.capabilities = AgentCapabilities.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
				...
				case /* repeated a2a.v1.Security security */ 9:
					message.security.push(
						Security.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				...
				case /* repeated a2a.v1.AgentSkill skills */ 12:
					message.skills.push(
						AgentSkill.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
	...
	private binaryReadMap8(
		map: AgentCard["securitySchemes"],
		reader: IBinaryReader,
		options: BinaryReadOptions,
	): void {
		let len = reader.uint32(),
			end = reader.pos + len,
			key: keyof AgentCard["securitySchemes"] | undefined,
			val: AgentCard["securitySchemes"][any] | undefined;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case 1:
					...
					break;
				case 2:
					val = SecurityScheme.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
					);
				...
				default:
					throw new globalThis.Error(
						"unknown map entry field for a2a.v1.AgentCard.security_schemes",
					);
			}
		}
	...
	internalBinaryWrite(
		...
		if (message.provider)
			AgentProvider.internalBinaryWrite(
				message.provider,
				writer.tag(4, WireType.LengthDelimited).fork(),
				options,
			).join();
		...
		if (message.capabilities)
			AgentCapabilities.internalBinaryWrite(
				message.capabilities,
		...
		for (let k of globalThis.Object.keys(message.securitySchemes)) {
			writer
				...
				.string(k);
			writer.tag(2, WireType.LengthDelimited).fork();
			SecurityScheme.internalBinaryWrite(
				message.securitySchemes[k],
				writer,
				options,
			);
			writer.join().join();
...
class AgentCapabilities$Type extends MessageType<AgentCapabilities> {
			...
			switch (fieldNo) {
				...
				case /* repeated a2a.v1.AgentExtension extensions */ 3:
					message.extensions.push(
						AgentExtension.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				default:
					let u = options.readUnknownField;
	...
	internalBinaryWrite(
		...
		for (let i = 0; i < message.extensions.length; i++)
			AgentExtension.internalBinaryWrite(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* google.protobuf.Struct params */ 4:
					message.params = Struct.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.params,
...
class TaskPushNotificationConfig$Type extends MessageType<TaskPushNotificationConfig> {
	...
	create(
		value?: PartialMessage<TaskPushNotificationConfig>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: TaskPushNotificationConfig,
	): TaskPushNotificationConfig {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.PushNotificationConfig push_notification_config */ 2:
					message.pushNotificationConfig =
						PushNotificationConfig.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							message.pushNotificationConfig,
...
class Security$Type extends MessageType<Security> {
	...
	private binaryReadMap1(
		...
		let len = reader.uint32(),
			...
			key: keyof Security["schemes"] | undefined,
			val: Security["schemes"][any] | undefined;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case 1:
				...
				default:
					throw new globalThis.Error(
						"unknown map entry field for a2a.v1.Security.schemes",
					);
			}
		}
...
class SecurityScheme$Type extends MessageType<SecurityScheme> {
	constructor() {
		super("a2a.v1.SecurityScheme", [
			...
			{
				no: 2,
				name: "http_auth_security_scheme",
				kind: "message",
				oneof: "scheme",
				T: () => HTTPAuthSecurityScheme,
			},
			{
				no: 3,
				...
				kind: "message",
				oneof: "scheme",
				T: () => OAuth2SecurityScheme,
			},
			{
				no: 4,
				name: "open_id_connect_security_scheme",
				kind: "message",
				oneof: "scheme",
				T: () => OpenIdConnectSecurityScheme,
			},
		]);
	}
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* a2a.v1.APIKeySecurityScheme api_key_security_scheme */ 1:
					message.scheme = {
						oneofKind: "apiKeySecurityScheme",
						apiKeySecurityScheme: APIKeySecurityScheme.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.scheme as any).apiKeySecurityScheme,
						),
					};
					break;
				case /* a2a.v1.HTTPAuthSecurityScheme http_auth_security_scheme */ 2:
					message.scheme = {
						oneofKind: "httpAuthSecurityScheme",
						httpAuthSecurityScheme: HTTPAuthSecurityScheme.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.scheme as any).httpAuthSecurityScheme,
						),
					};
					break;
				case /* a2a.v1.OAuth2SecurityScheme oauth2_security_scheme */ 3:
					message.scheme = {
						oneofKind: "oauth2SecurityScheme",
						oauth2SecurityScheme: OAuth2SecurityScheme.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.scheme as any).oauth2SecurityScheme,
						),
					};
					break;
				case /* a2a.v1.OpenIdConnectSecurityScheme open_id_connect_security_scheme */ 4:
					message.scheme = {
						...
						openIdConnectSecurityScheme:
							OpenIdConnectSecurityScheme.internalBinaryRead(
								reader,
								reader.uint32(),
								options,
								(message.scheme as any).openIdConnectSecurityScheme,
							),
					};
					break;
				default:
	...
	internalBinaryWrite(
		...
		if (message.scheme.oneofKind === "apiKeySecurityScheme")
			APIKeySecurityScheme.internalBinaryWrite(
				message.scheme.apiKeySecurityScheme,
				writer.tag(1, WireType.LengthDelimited).fork(),
				options,
			).join();
		/* a2a.v1.HTTPAuthSecurityScheme http_auth_security_scheme = 2; */
		if (message.scheme.oneofKind === "httpAuthSecurityScheme")
			HTTPAuthSecurityScheme.internalBinaryWrite(
				message.scheme.httpAuthSecurityScheme,
				writer.tag(2, WireType.LengthDelimited).fork(),
				options,
			).join();
		/* a2a.v1.OAuth2SecurityScheme oauth2_security_scheme = 3; */
		if (message.scheme.oneofKind === "oauth2SecurityScheme")
			OAuth2SecurityScheme.internalBinaryWrite(
				message.scheme.oauth2SecurityScheme,
				writer.tag(3, WireType.LengthDelimited).fork(),
				options,
			).join();
		...
		if (message.scheme.oneofKind === "openIdConnectSecurityScheme")
			OpenIdConnectSecurityScheme.internalBinaryWrite(
				message.scheme.openIdConnectSecurityScheme,
				writer.tag(4, WireType.LengthDelimited).fork(),
				options,
			).join();
		let u = options.writeUnknownFields;
...
class HTTPAuthSecurityScheme$Type extends MessageType<HTTPAuthSecurityScheme> {
	...
	create(
		value?: PartialMessage<HTTPAuthSecurityScheme>,
...
class OAuth2SecurityScheme$Type extends MessageType<OAuth2SecurityScheme> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.OAuthFlows flows */ 2:
					message.flows = OAuthFlows.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.flows,
	...
	internalBinaryWrite(
		...
		if (message.flows)
			OAuthFlows.internalBinaryWrite(
				message.flows,
				writer.tag(2, WireType.LengthDelimited).fork(),
				options,
			).join();
...
class OpenIdConnectSecurityScheme$Type extends MessageType<OpenIdConnectSecurityScheme> {
	...
	create(
		value?: PartialMessage<OpenIdConnectSecurityScheme>,
	): OpenIdConnectSecurityScheme {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.description = "";
...
export const OpenIdConnectSecurityScheme =
	new OpenIdConnectSecurityScheme$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OAuthFlows$Type extends MessageType<OAuthFlows> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* a2a.v1.AuthorizationCodeOAuthFlow authorization_code */ 1:
					message.flow = {
						oneofKind: "authorizationCode",
						authorizationCode: AuthorizationCodeOAuthFlow.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.flow as any).authorizationCode,
						),
					};
					break;
				case /* a2a.v1.ClientCredentialsOAuthFlow client_credentials */ 2:
					message.flow = {
						oneofKind: "clientCredentials",
						clientCredentials: ClientCredentialsOAuthFlow.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.flow as any).clientCredentials,
						),
					};
					break;
				case /* a2a.v1.ImplicitOAuthFlow implicit */ 3:
					message.flow = {
						oneofKind: "implicit",
						implicit: ImplicitOAuthFlow.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.flow as any).implicit,
						),
					};
					break;
				case /* a2a.v1.PasswordOAuthFlow password */ 4:
					message.flow = {
						oneofKind: "password",
						password: PasswordOAuthFlow.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.flow as any).password,
						),
					};
					break;
				default:
	...
	internalBinaryWrite(
		...
		if (message.flow.oneofKind === "authorizationCode")
			AuthorizationCodeOAuthFlow.internalBinaryWrite(
				message.flow.authorizationCode,
				writer.tag(1, WireType.LengthDelimited).fork(),
				options,
			).join();
		/* a2a.v1.ClientCredentialsOAuthFlow client_credentials = 2; */
		if (message.flow.oneofKind === "clientCredentials")
			ClientCredentialsOAuthFlow.internalBinaryWrite(
				message.flow.clientCredentials,
				writer.tag(2, WireType.LengthDelimited).fork(),
				options,
			).join();
		/* a2a.v1.ImplicitOAuthFlow implicit = 3; */
		if (message.flow.oneofKind === "implicit")
			ImplicitOAuthFlow.internalBinaryWrite(
				message.flow.implicit,
				writer.tag(3, WireType.LengthDelimited).fork(),
				options,
			).join();
		/* a2a.v1.PasswordOAuthFlow password = 4; */
		if (message.flow.oneofKind === "password")
			PasswordOAuthFlow.internalBinaryWrite(
				message.flow.password,
				writer.tag(4, WireType.LengthDelimited).fork(),
				options,
			).join();
		let u = options.writeUnknownFields;
...
class AuthorizationCodeOAuthFlow$Type extends MessageType<AuthorizationCodeOAuthFlow> {
	...
	create(
		value?: PartialMessage<AuthorizationCodeOAuthFlow>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: AuthorizationCodeOAuthFlow,
	): AuthorizationCodeOAuthFlow {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
	...
	private binaryReadMap4(
		map: AuthorizationCodeOAuthFlow["scopes"],
		reader: IBinaryReader,
		options: BinaryReadOptions,
	): void {
		let len = reader.uint32(),
			end = reader.pos + len,
			key: keyof AuthorizationCodeOAuthFlow["scopes"] | undefined,
			val: AuthorizationCodeOAuthFlow["scopes"][any] | undefined;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case 1:
				...
				default:
					throw new globalThis.Error(
						"unknown map entry field for a2a.v1.AuthorizationCodeOAuthFlow.scopes",
					);
			}
		}
		map[key ?? ""] = val ?? "";
...
class ClientCredentialsOAuthFlow$Type extends MessageType<ClientCredentialsOAuthFlow> {
	...
	create(
		value?: PartialMessage<ClientCredentialsOAuthFlow>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: ClientCredentialsOAuthFlow,
	): ClientCredentialsOAuthFlow {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
	...
	private binaryReadMap3(
		map: ClientCredentialsOAuthFlow["scopes"],
		reader: IBinaryReader,
		options: BinaryReadOptions,
	): void {
		let len = reader.uint32(),
			end = reader.pos + len,
			key: keyof ClientCredentialsOAuthFlow["scopes"] | undefined,
			val: ClientCredentialsOAuthFlow["scopes"][any] | undefined;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case 1:
				...
				default:
					throw new globalThis.Error(
						"unknown map entry field for a2a.v1.ClientCredentialsOAuthFlow.scopes",
					);
			}
		}
		map[key ?? ""] = val ?? "";
...
class ImplicitOAuthFlow$Type extends MessageType<ImplicitOAuthFlow> {
	...
	private binaryReadMap3(
		map: ImplicitOAuthFlow["scopes"],
		reader: IBinaryReader,
		options: BinaryReadOptions,
	): void {
		let len = reader.uint32(),
			end = reader.pos + len,
			key: keyof ImplicitOAuthFlow["scopes"] | undefined,
			val: ImplicitOAuthFlow["scopes"][any] | undefined;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case 1:
				...
				default:
					throw new globalThis.Error(
						"unknown map entry field for a2a.v1.ImplicitOAuthFlow.scopes",
					);
			}
		}
		map[key ?? ""] = val ?? "";
...
class PasswordOAuthFlow$Type extends MessageType<PasswordOAuthFlow> {
	...
	private binaryReadMap3(
		map: PasswordOAuthFlow["scopes"],
		reader: IBinaryReader,
		options: BinaryReadOptions,
	): void {
		let len = reader.uint32(),
			end = reader.pos + len,
			key: keyof PasswordOAuthFlow["scopes"] | undefined,
			val: PasswordOAuthFlow["scopes"][any] | undefined;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case 1:
				...
				default:
					throw new globalThis.Error(
						"unknown map entry field for a2a.v1.PasswordOAuthFlow.scopes",
					);
			}
		}
		map[key ?? ""] = val ?? "";
...
class SendMessageRequest$Type extends MessageType<SendMessageRequest> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* a2a.v1.Message request */ 1:
					message.request = Message.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.request,
				...
				case /* a2a.v1.SendMessageConfiguration configuration */ 2:
					message.configuration = SendMessageConfiguration.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
	...
	internalBinaryWrite(
		...
		if (message.configuration)
			SendMessageConfiguration.internalBinaryWrite(
				message.configuration,
				writer.tag(2, WireType.LengthDelimited).fork(),
				options,
			).join();
...
class GetTaskPushNotificationConfigRequest$Type extends MessageType<GetTaskPushNotificationConfigRequest> {
	...
	create(
		value?: PartialMessage<GetTaskPushNotificationConfigRequest>,
	): GetTaskPushNotificationConfigRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.name = "";
		if (value !== undefined)
			reflectionMergePartial<GetTaskPushNotificationConfigRequest>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: GetTaskPushNotificationConfigRequest,
	): GetTaskPushNotificationConfigRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
export const GetTaskPushNotificationConfigRequest =
	new GetTaskPushNotificationConfigRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeleteTaskPushNotificationConfigRequest$Type extends MessageType<DeleteTaskPushNotificationConfigRequest> {
	...
	create(
		value?: PartialMessage<DeleteTaskPushNotificationConfigRequest>,
	): DeleteTaskPushNotificationConfigRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.name = "";
		if (value !== undefined)
			reflectionMergePartial<DeleteTaskPushNotificationConfigRequest>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: DeleteTaskPushNotificationConfigRequest,
	): DeleteTaskPushNotificationConfigRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
export const DeleteTaskPushNotificationConfigRequest =
	new DeleteTaskPushNotificationConfigRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateTaskPushNotificationConfigRequest$Type extends MessageType<CreateTaskPushNotificationConfigRequest> {
	...
	create(
		value?: PartialMessage<CreateTaskPushNotificationConfigRequest>,
	): CreateTaskPushNotificationConfigRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.parent = "";
		message.configId = "";
		if (value !== undefined)
			reflectionMergePartial<CreateTaskPushNotificationConfigRequest>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: CreateTaskPushNotificationConfigRequest,
	): CreateTaskPushNotificationConfigRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.TaskPushNotificationConfig config */ 3:
					message.config = TaskPushNotificationConfig.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.config,
	...
	internalBinaryWrite(
		...
		if (message.config)
			TaskPushNotificationConfig.internalBinaryWrite(
				message.config,
				writer.tag(3, WireType.LengthDelimited).fork(),
				options,
			).join();
...
export const CreateTaskPushNotificationConfigRequest =
	new CreateTaskPushNotificationConfigRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TaskSubscriptionRequest$Type extends MessageType<TaskSubscriptionRequest> {
	...
	create(
		value?: PartialMessage<TaskSubscriptionRequest>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: TaskSubscriptionRequest,
	): TaskSubscriptionRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
class ListTaskPushNotificationConfigRequest$Type extends MessageType<ListTaskPushNotificationConfigRequest> {
	...
	create(
		value?: PartialMessage<ListTaskPushNotificationConfigRequest>,
		...
		message.pageToken = "";
		if (value !== undefined)
			reflectionMergePartial<ListTaskPushNotificationConfigRequest>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: ListTaskPushNotificationConfigRequest,
	): ListTaskPushNotificationConfigRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
export const ListTaskPushNotificationConfigRequest =
	new ListTaskPushNotificationConfigRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* a2a.v1.Task task */ 1:
					message.payload = {
						oneofKind: "task",
						task: Task.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.payload as any).task,
						),
					};
					break;
				case /* a2a.v1.Message msg */ 2:
					message.payload = {
						oneofKind: "msg",
						msg: Message.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
...
class StreamResponse$Type extends MessageType<StreamResponse> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* a2a.v1.TaskStatusUpdateEvent status_update */ 3:
					message.payload = {
						oneofKind: "statusUpdate",
						statusUpdate: TaskStatusUpdateEvent.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.payload as any).statusUpdate,
						),
					};
					break;
				case /* a2a.v1.TaskArtifactUpdateEvent artifact_update */ 4:
					message.payload = {
						oneofKind: "artifactUpdate",
						artifactUpdate: TaskArtifactUpdateEvent.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.payload as any).artifactUpdate,
						),
					};
					break;
				default:
	...
	internalBinaryWrite(
		...
		if (message.payload.oneofKind === "statusUpdate")
			TaskStatusUpdateEvent.internalBinaryWrite(
				message.payload.statusUpdate,
				writer.tag(3, WireType.LengthDelimited).fork(),
				options,
			).join();
		/* a2a.v1.TaskArtifactUpdateEvent artifact_update = 4; */
		if (message.payload.oneofKind === "artifactUpdate")
			TaskArtifactUpdateEvent.internalBinaryWrite(
				message.payload.artifactUpdate,
				writer.tag(4, WireType.LengthDelimited).fork(),
				options,
			).join();
		let u = options.writeUnknownFields;
...
class ListTaskPushNotificationConfigResponse$Type extends MessageType<ListTaskPushNotificationConfigResponse> {
	...
	create(
		value?: PartialMessage<ListTaskPushNotificationConfigResponse>,
	): ListTaskPushNotificationConfigResponse {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.configs = [];
		message.nextPageToken = "";
		if (value !== undefined)
			reflectionMergePartial<ListTaskPushNotificationConfigResponse>(
				this,
				message,
				value,
			);
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: ListTaskPushNotificationConfigResponse,
	): ListTaskPushNotificationConfigResponse {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* repeated a2a.v1.TaskPushNotificationConfig configs */ 1:
					message.configs.push(
						TaskPushNotificationConfig.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
						),
...
export const ListTaskPushNotificationConfigResponse =
	new ListTaskPushNotificationConfigResponse$Type();
/**
...
export const A2AService = new ServiceType("a2a.v1.A2AService", [
	{
		name: "SendMessage",
		options: { "google.api.http": { post: "/v1/message:send", body: "*" } },
	...
	},
	{
		...
		options: { "google.api.http": { post: "/v1/message:stream", body: "*" } },
		I: SendMessageRequest,
		O: StreamResponse,
	},
	{
		name: "GetTask",
		options: {
			"google.api.http": { get: "/v1/{name=tasks/*}" },
	...
	},
	{
		name: "CancelTask",
		options: {
			"google.api.http": { post: "/v1/{name=tasks/*}:cancel", body: "*" },
		},
		I: CancelTaskRequest,
		O: Task,
	},
	{
		...
		serverStreaming: true,
		options: { "google.api.http": { get: "/v1/{name=tasks/*}:subscribe" } },
	...
	{
		name: "GetAgentCard",
		options: { "google.api.http": { get: "/v1/card" } },
