...
import { DeleteTaskPushNotificationConfigRequest } from "./a2a.js";
import { AgentCard } from "./a2a.js";
import { GetAgentCardRequest } from "./a2a.js";
import { ListTaskPushNotificationConfigResponse } from "./a2a.js";
import { ListTaskPushNotificationConfigRequest } from "./a2a.js";
import { GetTaskPushNotificationConfigRequest } from "./a2a.js";
import { TaskPushNotificationConfig } from "./a2a.js";
import { CreateTaskPushNotificationConfigRequest } from "./a2a.js";
import { TaskSubscriptionRequest } from "./a2a.js";
import { CancelTaskRequest } from "./a2a.js";
import { Task } from "./a2a.js";
import { GetTaskRequest } from "./a2a.js";
import { StreamResponse } from "./a2a.js";
import { SendMessageResponse } from "./a2a.js";
import { SendMessageRequest } from "./a2a.js";
...
export const a2AServiceDefinition: grpc.ServiceDefinition<IA2AService> = {
	sendMessage: {
		...
		responseSerialize: (value) =>
			Buffer.from(SendMessageResponse.toBinary(value)),
		requestSerialize: (value) =>
			Buffer.from(SendMessageRequest.toBinary(value)),
	},
	...
	taskSubscription: {
		...
		responseSerialize: (value) => Buffer.from(StreamResponse.toBinary(value)),
		requestSerialize: (value) =>
			Buffer.from(TaskSubscriptionRequest.toBinary(value)),
	},
	createTaskPushNotificationConfig: {
		...
		responseDeserialize: (bytes) =>
			TaskPushNotificationConfig.fromBinary(bytes),
		requestDeserialize: (bytes) =>
			CreateTaskPushNotificationConfigRequest.fromBinary(bytes),
		responseSerialize: (value) =>
			Buffer.from(TaskPushNotificationConfig.toBinary(value)),
		requestSerialize: (value) =>
			Buffer.from(CreateTaskPushNotificationConfigRequest.toBinary(value)),
	},
	getTaskPushNotificationConfig: {
		...
		responseDeserialize: (bytes) =>
			TaskPushNotificationConfig.fromBinary(bytes),
		requestDeserialize: (bytes) =>
			GetTaskPushNotificationConfigRequest.fromBinary(bytes),
		responseSerialize: (value) =>
			Buffer.from(TaskPushNotificationConfig.toBinary(value)),
		requestSerialize: (value) =>
			Buffer.from(GetTaskPushNotificationConfigRequest.toBinary(value)),
	},
	listTaskPushNotificationConfig: {
		...
		responseStream: false,
		responseDeserialize: (bytes) =>
			ListTaskPushNotificationConfigResponse.fromBinary(bytes),
		requestDeserialize: (bytes) =>
			ListTaskPushNotificationConfigRequest.fromBinary(bytes),
		responseSerialize: (value) =>
			Buffer.from(ListTaskPushNotificationConfigResponse.toBinary(value)),
		requestSerialize: (value) =>
			Buffer.from(ListTaskPushNotificationConfigRequest.toBinary(value)),
	},
	getAgentCard: {
		...
		requestSerialize: (value) =>
			Buffer.from(GetAgentCardRequest.toBinary(value)),
	},
	deleteTaskPushNotificationConfig: {
		...
		requestDeserialize: (bytes) =>
			DeleteTaskPushNotificationConfigRequest.fromBinary(bytes),
		responseSerialize: (value) => Buffer.from(Empty.toBinary(value)),
		requestSerialize: (value) =>
			Buffer.from(DeleteTaskPushNotificationConfigRequest.toBinary(value)),
	},
};
