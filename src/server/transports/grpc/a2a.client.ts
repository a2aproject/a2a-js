...
import { A2AService } from "./a2a.js";
import type { Empty } from "./google/protobuf/empty.js";
import type { DeleteTaskPushNotificationConfigRequest } from "./a2a.js";
import type { AgentCard } from "./a2a.js";
import type { GetAgentCardRequest } from "./a2a.js";
import type { ListTaskPushNotificationConfigResponse } from "./a2a.js";
import type { ListTaskPushNotificationConfigRequest } from "./a2a.js";
import type { GetTaskPushNotificationConfigRequest } from "./a2a.js";
import type { TaskPushNotificationConfig } from "./a2a.js";
import type { CreateTaskPushNotificationConfigRequest } from "./a2a.js";
import type { TaskSubscriptionRequest } from "./a2a.js";
import type { CancelTaskRequest } from "./a2a.js";
import type { Task } from "./a2a.js";
import type { GetTaskRequest } from "./a2a.js";
import type { StreamResponse } from "./a2a.js";
import type { ServerStreamingCall } from "@protobuf-ts/runtime-rpc";
import { stackIntercept } from "@protobuf-ts/runtime-rpc";
import type { SendMessageResponse } from "./a2a.js";
import type { SendMessageRequest } from "./a2a.js";
...
export interface IA2AServiceClient {
	...
	sendStreamingMessage(
		input: SendMessageRequest,
		options?: RpcOptions,
	): ServerStreamingCall<SendMessageRequest, StreamResponse>;
	/**
	...
	cancelTask(
		...
		options?: RpcOptions,
	): UnaryCall<CancelTaskRequest, Task>;
	/**
	 ...
	 */
	taskSubscription(
		input: TaskSubscriptionRequest,
		options?: RpcOptions,
	): ServerStreamingCall<TaskSubscriptionRequest, StreamResponse>;
	/**
	...
	getTaskPushNotificationConfig(
		input: GetTaskPushNotificationConfigRequest,
		options?: RpcOptions,
	): UnaryCall<
	...
	listTaskPushNotificationConfig(
		input: ListTaskPushNotificationConfigRequest,
		options?: RpcOptions,
	): UnaryCall<
	...
	getAgentCard(
		...
		options?: RpcOptions,
	): UnaryCall<GetAgentCardRequest, AgentCard>;
	/**
	...
	deleteTaskPushNotificationConfig(
		...
		options?: RpcOptions,
	): UnaryCall<DeleteTaskPushNotificationConfigRequest, Empty>;
}
/**
 * A2AService defines the gRPC version of the A2A protocol. This has a slightly
 * different shape than the JSONRPC version to better conform to AIP-127,
...
export class A2AServiceClient implements IA2AServiceClient, ServiceInfo {
	...
	sendStreamingMessage(
		...
		const method = this.methods[1],
			opt = this._transport.mergeOptions(options);
		return stackIntercept<SendMessageRequest, StreamResponse>(
			"serverStreaming",
			this._transport,
			method,
			opt,
	...
	cancelTask(
		...
		const method = this.methods[3],
			opt = this._transport.mergeOptions(options);
		return stackIntercept<CancelTaskRequest, Task>(
			"unary",
			this._transport,
			method,
			opt,
	...
	taskSubscription(
		...
		const method = this.methods[4],
			opt = this._transport.mergeOptions(options);
		return stackIntercept<TaskSubscriptionRequest, StreamResponse>(
			"serverStreaming",
			this._transport,
			method,
			opt,
	...
	getAgentCard(
		...
		const method = this.methods[8],
			opt = this._transport.mergeOptions(options);
		return stackIntercept<GetAgentCardRequest, AgentCard>(
			"unary",
			this._transport,
			method,
			opt,
	...
	deleteTaskPushNotificationConfig(
		...
		const method = this.methods[9],
			opt = this._transport.mergeOptions(options);
		return stackIntercept<DeleteTaskPushNotificationConfigRequest, Empty>(
			"unary",
			this._transport,
			method,
			opt,
