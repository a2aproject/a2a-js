...
export const Security: MessageFns<Security> = {
  ...
  fromPartial<I extends Exact<DeepPartial<Security>, I>>(object: I): Security {
    const message = createBaseSecurity();
    message.schemes = (globalThis.Object.entries(object.schemes ?? {}) as [string, StringList][]).reduce(
...
export const AuthorizationCodeOAuthFlow: MessageFns<AuthorizationCodeOAuthFlow> = {
  ...
  fromPartial<I extends Exact<DeepPartial<AuthorizationCodeOAuthFlow>, I>>(object: I): AuthorizationCodeOAuthFlow {
    ...
    message.scopes = (globalThis.Object.entries(object.scopes ?? {}) as [string, string][]).reduce(
