...
| [`agents/websocket-agent`](src/samples/agents/websocket-agent/)                 | Authenticated WebSocket agent and client demonstrating streaming plus a concurrent unary request over one connection.                          |
