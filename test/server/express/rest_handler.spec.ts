...
describe('restHandler', () => {
  ...
  describe('GET /extendedAgentCard', () => {
    ...
    it('should return 500 if getAuthenticatedExtendedAgentCard fails', async () => {
      ...
      const response = await request(app).get('/extendedAgentCard').expect(500);
  ...
  describe('POST /message:send', () => {
    ...
    it('should return 400 when message is invalid', async () => {
      ...
      await request(app).post('/message:send').send({ message: null }).expect(400);
    });
  });
  ...
  describe('POST /message:stream', () => {
    ...
    it('should return 400 if streaming is not supported', async () => {
      ...
      await request(noStreamApp).post('/message:stream').send({ message: testMessage }).expect(400);
    });
  });
  ...
  describe('Error Handling', () => {
    it('should return 404 for unknown message action (route not matched)', async () => {
      ...
      await request(app).post('/message:unknown').send({ message: testMessage }).expect(404);
    });
